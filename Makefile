OBJECTS= ./build/compiler.o ./build/cprocess.o ./build/lexer.o ./build/parser.o ./build/token.o ./build/lex_process.o ./build/helpers/vector.o ./build/helpers/buffer.o
INCLUDES= -I./
